  ...
  return (
    <div className="bg-white w-full h-[50px] md:h-[80px]  flex justify-between items-center px-4 text-black text-3xl font-bold">
      ...
      <div
        className={
          nav
            ? "absolute top-0 left-0 w-full h-screen bg-[#111111] text-white flex flex-col justify-center items-center"
            : "hidden"
        }
      >
        <ul>
      ...
      <div className="hidden fixed md:flex flex-col top-[45%] left-0 font-light text-xl">
        <ul>
          <li className="ml-[-105px] hover:ml-[-10px] duration-300">
            <a
              href="https://www.linkedin.com/in/niklas-schmidts/"
          ...
          <li className="ml-[-63px] hover:ml-[-10px] duration-300">
            <a
              href="https://www.xing.com/profile/Niklas_Schmidts2/"
              className="flex items-center text-white"
            >
          ...
          <li className="ml-[-90px] hover:ml-[-10px] duration-300">
            <a
              href="https://github.com/NiklasSchmidts"
              className="flex items-center text-white"
            >
